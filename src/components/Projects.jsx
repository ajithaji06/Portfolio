...
const Projects = () => {
  return (
    <div id='project' className="min-h-screen  w-full flex flex-col items-center gap-5 px-4 py-10 mt-30 pt-9">
        <div className="text-center mt-15 max-w-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-5xl">
          {projects.map((project) => (
            <div key={project.id} className="bg-primary/20 gradient-border card-hover shadow-lg rounded-2xl p-2 transition hover:scale-[1.02] hover:shadow-xl duration-300">
